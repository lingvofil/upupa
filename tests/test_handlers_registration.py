...
EXPECTED_TOTAL_HANDLERS = 131  # + 4 обработчика интерактивной дипломатии
...
def test_world_router_is_registered_before_dialog():
    from handlers import ROUTERS, dialog, world, world_hub, world_interactions, world_listing

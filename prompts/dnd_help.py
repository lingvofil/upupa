...
DND_HELP_BLOCK = (
    ...
    "<code>днд партии</code> - краткий список сохранённых завершённых партий и их итогов\n"
    ...
    "Команды состояния героя, инвентаря, связей, сюжета и истории партий работают и между партиями. "
...
def install_dnd_help(help_texts_module) -> None:
    ...
    if (
        "<code>днд партии</code>" in section
        and "<code>днд сюжет</code>" in section

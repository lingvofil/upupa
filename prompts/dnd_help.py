...
DND_HELP_BLOCK = (
    ...
    "Перед сюжетом выбери короткую/длинную игру и при желании цель миссии; «Свой сюжет» позволяет написать завязку вручную.\n"
    "<code>захожу</code> - присоединиться или вернуться по ходу партии\n"
    "<code>ушел</code> / <code>ушла</code> - выйти из сцены, сохранив героя и вещи\n"
    "<code>лечить</code> - открыть выбор лечения во время партии\n"
    "<code>днд партии</code> - краткий список сохранённых завершённых партий и их итогов\n"
    "<code>днд партия</code> - текущая сцена, чей ход и какое действие нужно; можно ответить на это сообщение\n"
...
def install_dnd_help(help_texts_module) -> None:
    ...
    if (
        ...
        and "<code>захожу</code>" in section
    ):
        return

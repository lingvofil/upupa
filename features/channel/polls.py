...
Придумай один короткий опрос в характере Упупы: живой, хулиганский, абсурдный или слегка ехидный.
Это не социологическое исследование и не просьба аудитории выбрать тему для полезного контента.
Чередуй темы: нелепые решения, состояния, еда, улица, музыка, работа, интернет, тело, привычки,
воображаемые правила и случайные человеческие ритуалы. Не делай бытовую технику и мебель постоянной темой
и не возвращайся к тостерам, чайникам, табуреткам и похожему реквизиту только ради узнаваемости.
...
Напиши одну короткую реакцию на итог. Сообщение будет отправлено РЕПЛАЕМ на исходный опрос, поэтому
читателю уже виден контекст. Это не отчёт и не перечисление статистики:

...
# Ten minutes intentionally covers the common pattern where reactions keep
# accumulating for several minutes after a message was posted.
OBSERVATION_WINDOW_SECONDS = _int("UPUPA_CHRONICLE_OBSERVATION_WINDOW_SECONDS", 600, minimum=30)

...
# Шкала намеренно смещена вверх относительно обычного «Кракадила наоборот»:
...
WORD_POOLS = {
    ...
    "hard": (
        ...
        "Аристократия", "Банкротство", "Вердикт", "Вдохновение", "Дилемма", "Диссонанс", "Иерархия",
        "Инерция", "Компромисс", "Контраст", "Меланхолия", "Ностальгия", "Парадокс", "Предчувствие",
        "Прецедент", "Резонанс", "Сарказм", "Симметрия", "Суеверие", "Традиция", "Эйфория",
        "Аллегория", "Догма", "Интрига", "Метафора", "Озарение", "Пропаганда", "Утопия", "Фанатизм",
    ),
}

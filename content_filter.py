...
STOP_WORDS = [
    ...
    "в личные сообщения", "в личные сообщение", 
    "пиши в лс", "пишите в лс", "отвечу в лс", "жду в лс", 
    "подробности в лс", "подробности в личке", "в директ", "в direct",
    "по всем вопросам в лс", "расскажу подробно", "напиши мне на",

    # --- Общие слова про заработок, работу, доход ---
    "зарабатывай", "пассивный доход", "дополнительный доход", 
    "работа на дому", "удаленная работа", "работа онлайн", 
    "работа в интернете",

    # --- Рекрутинг, набор людей ---
    "требуются", "нужны ребята", "нужны люди", "ищу людей", 
    ...
    "приглашаю в команду", "срочно требуются", "возьму в команду", "срочно нужны",

    # --- Оплата и деньги ---
    "оплата каждый день", "оплата по факту", "деньги тут", "нужны деньги",
    "быстрые деньги", "легкие деньги",

    # --- "Без вложений" и другие заманухи ---
    "без вложений", "вложения не нужны", "места ограничены", "успей", 

    # --- Тематики: Криптовалюты, Трейдинг, Казино ---
    "crypto", "крипта", "криптовалюта", "нфт", "nft", 

...
- **DM adjudication discipline — готово в PR #734:** не бросать на очевидный успех/невозможность/безрисковый retry, разделять CHECK/SAVE/ATTACK, сначала выбирать характеристику по подходу и только потом навык;
- **Group progress / late join / visible inventory bonuses — в работе в текущем stacked PR:** конкретная обратная связь на исследовательские групповые заявки, защита от третьего пустого общего INPUT, поздний участник остаётся обязательным участником общего хода даже до появления combat sheet, явные бонусы вещей всегда видны в «герой»/«инвентарь»;

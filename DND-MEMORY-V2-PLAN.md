...
- **SESSION CANON — в работе в PR #733:** детерминированный снимок только структурированно подтверждённых фактов, команда `днд канон`, сохранение снимка в архив завершённой партии и legacy fallback для старых архивов;
